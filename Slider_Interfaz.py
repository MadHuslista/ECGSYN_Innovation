...
s_n         = Slider(ax_n, 'Pulsaciones Simuladas', 2, 50, valinit=5, valstep=1,valfmt = "%3d")
...
s_c1        = Slider(ax_c1, 'Desviación Estándar Onda Mayer', 0.01, 0.5, valinit=0.01, valstep=0.01, valfmt = "%4.2f [Hz]")
s_c2        = Slider(ax_c2, 'Desviación Estándar Onda RSA', 0.01, 0.5, valinit=0.15, valstep=0.01, valfmt = "%4.2f [Hz]")
